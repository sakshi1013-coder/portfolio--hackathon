...
export const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    type: "Internship",
    description:
      "Frontend Developer Intern at Hari Om Thalassic Pvt. Ltd., where I worked on designing and developing user-facing web interfaces. I worked with Figma to understand and create UI designs, translated designs into responsive and functional frontend components, and refined interfaces to improve usability and overall user experience. Collaborated with the development team to implement features, solve frontend issues, meet deadlines, and deliver quality web solutions while gaining hands-on industry experience.",
    responsibilities: [
      "Worked with Figma to design, understand, and prototype intuitive user-facing web interfaces.",
      "Translated Figma UI designs into responsive, clean, and functional frontend components.",
      "Refined web interfaces to elevate usability, design consistency, and overall user experience.",
      "Collaborated closely with the development team to implement features, solve frontend issues, and deliver quality web solutions.",
    ],
    technologies: ["Figma (Software)", "HTML", "CSS", "JavaScript", "React", "Frontend Development", "UI/UX Design"],
    outcomes: "Delivered responsive web components and improved usability across core user-facing web interfaces.",
  },
  {
    id: "exp-moodindigo",
