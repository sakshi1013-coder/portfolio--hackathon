...
const featuredProjects: FeaturedProject[] = [
  {
    id: 'aura',
    title: 'Aura',
    tagline: '1st Place Hackathon Winner · Women’s Healthtech & Reverse-Chronobiology Engine',
    purpose: 'Built Aura — a daily guidance platform and Reverse-Chronobiology Engine for women’s health that converts real-time symptom check-ins into actionable cycle guidance and culturally-relevant Indian nutrition (Aura Rasoi).',
    color: '#EC4899',
    badge: '1ST PLACE HACKATHON WINNER',
    archNodes: [
      { label: 'Frontend & UI/UX', sub: 'Next.js + Tailwind CSS', icon: 'React' },
      { label: 'Quick Check-in', sub: '10s Swiper & Voice Input', icon: 'Next.js' },
      { label: 'Prediction Engine', sub: 'Reverse-Chronobiology AI', icon: 'Prompt Engineering' },
      { label: 'Aura Rasoi', sub: 'Cycle-Synced Nutrition', icon: 'Node.js' },
    ],
    highlights: [
      'Awarded 1st Place Winner at SummerHacks 2026 (ITM x Notion) in Healthtech (Team Straw Hats)',
      'Frictionless 10-second Tinder-style swiper & voice input replacing grueling onboarding flows',
      'Reverse-Chronobiology Engine predicting cycle phases (Menstrual, Follicular, Ovulatory, Luteal) from real-time symptoms',
      'Aura Rasoi: Cycle-synced Indian recipes tailored for PCOS, Indian kitchens, and cultural fasting',
    ],
    tech: ['Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'Healthtech AI', 'Node.js'],
