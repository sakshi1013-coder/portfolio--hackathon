...
const links = [
  ...
  },
  {
    id: 'instagram',
    label: 'INSTAGRAM',
    description: 'Design snapshots, hackathon highlights & life.',
    href: 'https://www.instagram.com/sakshi_shingole?igsh=azdtYWF6azRpeHA1',
    cursorLabel: '↗',
    color: '#E1306C',
    bg: '#FDF2F8',
    icon: <InstagramIcon />,
  ...
  },
  {
    id: 'x-twitter',
    label: 'X (TWITTER)',
    description: 'Thoughts on software, AI tools & building.',
    href: 'https://x.com/saku_8055?t=yTgvW2O49wvmDHFF0X7Y5A&s=09',
    cursorLabel: '↗',
    color: '#0F172A',
    bg: '#F1F5F9',
    icon: <XTwitterIcon />,
  ...
  },
  {
    id: 'resume',
    label: 'RESUME',
    description: 'View my latest curriculum vitae.',
    href: '/resume',
    cursorLabel: '↗',
    color: '#6257E8',
    bg: '#E9E7FF',
